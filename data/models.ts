...
export const modelsData: DirectoryItem[] = [
  {
    ...
    creator: "OpenAI",
    license: "Propietario",
    description: "Modelo multimodal de última generación. Procesa texto, imágenes y audio con latencia reducida.",
    metrics: [
      { label: "Contexto", value: "128K" },
      { label: "Coste", value: "$2.50/1M input" },
      { label: "Latencia", value: "~300ms" },
    ],
    useCase: "Automatización de documentos, análisis visual, chatbots empresariales con contexto largo.",
    adoptionStatus: "Producción masiva. Estándar de facto para empresas Fortune 500. Estabilidad probada.",
  ...
  },
  {
    ...
    creator: "Anthropic",
    license: "Propietario",
    description: "Modelo de razonamiento avanzado con foco en seguridad. Excelente para código y análisis complejo.",
    metrics: [
      { label: "Contexto", value: "200K" },
      { label: "Coste", value: "$3/1M input" },
      { label: "Latencia", value: "~400ms" },
    ],
    useCase: "Code review, análisis de compliance, agentes autónomos de alto nivel.",
